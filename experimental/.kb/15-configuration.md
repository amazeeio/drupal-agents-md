...
description: >
  Drupal's Configuration API: schema definition, install vs optional config,
  reading/writing config, config split for per-environment settings, and
  Drush config workflow commands.
