...
description: >
  Drupal coding standards, linting rules, and code quality enforcement.
  These rules MUST be followed on every code change. Reject any code that
  fails Drupal Coder sniffs.
